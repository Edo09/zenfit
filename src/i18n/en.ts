export default {
  ...
  profile: {
    ...
    aiSuccess_one: "{{count}} routine created!",
    aiSuccess_other: "{{count}} routines created!",
  ...
  coach: {
    ...
    todayPlan: "Today's session",
    tomorrowPlan: "Tomorrow's session",
    inDays_one: "In {{count}} day",
    inDays_other: "In {{count}} days",
    anyDay: "Whenever you like",
    exercisesCount_one: "{{count}} exercise",
    exercisesCount_other: "{{count}} exercises",
    trainNow: "Train",
  },

  // Coach-assigned nutrition plan + supplement stack (read-only client view)
  nutritionPlan: {
    tabTitle: "Nutrition",
    segmentPlan: "Plan",
    ...
    autoFromRoutines: "From your assigned routines",
  ...
  // Rest timer between sets (global, floats above the dock)
  restTimer: {
    eyebrow: "Rest",
    done: "Rest complete!",
    notifBody: "Back to it — next set is up.",
    notifNext: "Back to it — {{name}}",
    pause: "Pause rest",
    resume: "Resume rest",
    skip: "Skip rest",
