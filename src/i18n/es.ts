export default {
  ...
  auth: {
    ...
    tagline: "Evoluciona sin límites.",
    logIn: "Entrar",
  ...
  profile: {
    ...
    aiSuccess_one: "¡{{count}} rutina creada!",
    aiSuccess_other: "¡{{count}} rutinas creadas!",
    ...
    aiFocusLabel: "Enfoque",
    aiFocusMix: "Mixto",
    aiFocusChest: "Pecho",
    aiFocusBack: "Espalda",
    aiFocusShoulders: "Hombros",
    aiFocusArms: "Brazos",
    aiFocusLegs: "Piernas",
    aiFocusCore: "Core",
    aiFocusCardio: "Cardio",
    aiFocusEmpty: "Aún no hay ejercicios del enfoque seleccionado en el catálogo",
    statWeight: "Peso",
    unitYears: "años",
  ...
  nutritionPlan: {
    ...
    autoFromRoutines: "Según tus rutinas asignadas",
  ...
  restTimer: {
    ...
    notifBody: "A darle — toca la siguiente serie.",
    notifNext: "A darle — {{name}}",
    pause: "Pausar descanso",
    resume: "Reanudar descanso",
    skip: "Saltar descanso",
    add30: "Añadir 30 segundos",
  },
} as const;
